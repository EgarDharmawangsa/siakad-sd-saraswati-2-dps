...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('siswa', function (Blueprint $table) {
            ...
            $table->string('alat_transportasi', 50);
            $table->string('no_telepon_rumah', 20)->nullable();
            $table->string('no_telepon_seluler', 20);
            $table->string('e_mail')->unique()->nullable();
            $table->string('disabilitas', 50); 
            $table->string('keterangan_disabilitas', 255)->nullable();
            $table->string('sekolah_asal', 100)->nullable();
            $table->string('no_peserta_un', 50)->nullable();
            $table->string('no_seri_ijazah', 50)->nullable()->unique();
            $table->string('penerima_kps', 10); 
            $table->string('no_kps', 50)->unique()->nullable();
            $table->string('penerima_kip', 10);
            $table->string('no_kip', 50)->unique()->nullable();
            $table->string('nama_kip', 100)->nullable();
            $table->string('layak_pip', 10);
