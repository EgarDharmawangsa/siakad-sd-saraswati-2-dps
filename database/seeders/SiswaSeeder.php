    ...
    public function run(): void
    {
        $siswaData = [
            ...
            [
                'id_kelas' => 2,
                'nomor_urut' => 3,
                'no_kk' => '5171010101200008',
                'nik' => '5171010101180008',
                'nisn' => '0071234508',
                'nipd' => '2018003',
                'nama_siswa' => 'I Made Artha',
                'jenis_kelamin' => 'Laki-laki',
                'agama' => 'Hindu',
                'tempat_lahir' => 'Denpasar',
                ...
                'jenis_tinggal' => 'Bersama Orang Tua',
                'alat_transportasi' => 'Sepeda',
                'no_telepon_seluler' => '081234567008',
                'disabilitas' => 'Tidak',
                'penerima_kps' => 'Tidak',
                'penerima_kip' => 'Tidak',
                'layak_pip' => 'Tidak',
                'nama_ayah' => 'I Wayan Artha',
                'nama_ibu' => 'Ni Made Sari',
            ],
            [
                'id_kelas' => 2,
                'nomor_urut' => 4,
                'no_kk' => '5171020303200009',
                'nik' => '5171020303170009',
                'nisn' => '0071234509',
                'nipd' => '2017002',
                'nama_siswa' => 'Ni Komang Sekar',
                'jenis_kelamin' => 'Perempuan',
                'agama' => 'Hindu',
                'tempat_lahir' => 'Tabanan',
                'tanggal_lahir' => '2017-05-18',
                'alamat' => 'Jl. Raya Tabanan No. 30, Tabanan',
                'rt' => '03', 'rw' => '02',
                'kelurahan' => 'Tabanan',
                'kecamatan' => 'Tabanan',
                'jenis_tinggal' => 'Bersama Orang Tua',
                'alat_transportasi' => 'Motor',
                'no_telepon_seluler' => '081234567009',
                'disabilitas' => 'Tidak',
                'penerima_kps' => 'Tidak',
                'penerima_kip' => 'Ya',
                'no_kip' => 'KIP0001234509',
                'nama_kip' => 'Ni Komang Sekar',
                'layak_pip' => 'Ya',
                'alasan_layak_pip' => 'Pemegang KIP',
                'nama_ayah' => 'I Made Suka',
                'nama_ibu' => 'Ni Wayan Rini',
            ],
            [
                'id_kelas' => 2,
                'nomor_urut' => 5,
                'no_kk' => '5171030404200010',
                'nik' => '5171030404160010',
                'nisn' => '0071234510',
                'nipd' => '2016002',
                'nama_siswa' => 'I Gusti Ngurah Mahendra',
                'jenis_kelamin' => 'Laki-laki',
                'agama' => 'Hindu',
                'tempat_lahir' => 'Badung',
                'tanggal_lahir' => '2016-08-22',
                'alamat' => 'Jl. Raya Kuta No. 80, Badung',
                'rt' => '01', 'rw' => '02',
                'kelurahan' => 'Kuta',
                'kecamatan' => 'Kuta',
                'jenis_tinggal' => 'Bersama Orang Tua',
                'alat_transportasi' => 'Sepeda',
                'no_telepon_seluler' => '081234567010',
                'disabilitas' => 'Tidak',
                'penerima_kps' => 'Tidak',
                'penerima_kip' => 'Tidak',
                'layak_pip' => 'Tidak',
                'nama_ayah' => 'I Made Mahendra',
                'nama_ibu' => 'Ni Luh Citra',
            ],
        ];
