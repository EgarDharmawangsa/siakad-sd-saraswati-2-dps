...
Route::middleware('auth')->group(function () {
    ...
    Route::resource('/semester', SemesterController::class)->except('show')->middleware('role:staf-tata-usaha,guru');
    Route::resource('/mata-pelajaran', MataPelajaranController::class)->except('show')->middleware('role:staf-tata-usaha,guru');
