...
<body id="page-body" class="d-flex flex-column vh-100 p-0 m-0" data-route-name="{{ Route::currentRouteName() }}">
    ...
    @if (session()->has('success'))
        <div class="toast show align-items-center w-auto text-bg-success border-0 mb-2 shadow-lg" role="alert" aria-live="assertive" aria-atomic="true" style="max-width: none;">
            <div class="d-flex">
