                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control @error('nipd') is-invalid @enderror" name="nipd"
                                value="{{ old('nipd', $user->nipd) }}" placeholder="Masukkan NIPD" required>
                            @error('nipd')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control @error('no_telepon_rumah') is-invalid @enderror" name="no_telepon_rumah"
                                value="{{ old('no_telepon_rumah', $user->no_telepon_rumah) }}" placeholder="Masukkan no. telp rumah">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control @error('no_telepon_seluler') is-invalid @enderror"
                                ...
                                value="{{ old('no_telepon_seluler', $user->no_telepon_seluler) }}" placeholder="Masukkan no. hp" required>
                        ...
                        <div class="col-md-6"><label class="form-label">Berat Badan (kg)</label><input type="number"
                                ...
                                value="{{ old('berat_badan', $user->berat_badan) }}" placeholder="Masukkan berat badan">
                            @error('berat_badan')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-md-6"><label class="form-label">Tinggi Badan (cm)</label><input type="number"
                                ...
                                value="{{ old('tinggi_badan', $user->tinggi_badan) }}" placeholder="Masukkan tinggi badan">
                            @error('tinggi_badan')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-md-6"><label class="form-label">Lingkar Kepala (cm)</label><input type="number"
                                ...
                                value="{{ old('lingkar_kepala', $user->lingkar_kepala) }}" placeholder="Masukkan lingkar kepala">
