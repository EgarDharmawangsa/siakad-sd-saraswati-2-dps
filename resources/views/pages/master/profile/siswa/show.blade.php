            ...
            <div class="tab-pane fade show active" id="view-pribadi">
                <div class="row g-3">
                    <div class="col-md-12 mt-4 d-flex justify-content-center">
                        @if ($user->foto)
                            <img src="{{ asset("storage/{$user->foto}") }}" alt="Foto Siswa" class="foto my-3">
                        @else
                    ...
                    <div class="col-md-8">
                        ...
                        <input type="text" class="form-control" value="{{ $user->keterangan_disabilitas ?? '-' }}"
                            readonly>
                    </div>
                </div>
                    ...
                    <div class="tab-pane fade show active" id="detail-ayah">
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" value="{{ $user->nama_ayah ?? '-' }}"
                                    readonly>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">NIK Ayah</label>
                                <input type="text" class="form-control" value="{{ $user->nik_ayah ?? '-' }}"
                                    readonly>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control"
                                    value="{{ $user->jenjang_pendidikan_ayah ?? '-' }}" readonly>
                            </div>
                            <div class="col-md-6">
                    ...
                    <div class="tab-pane fade" id="detail-ibu">
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" value="{{ $user->nama_ibu ?? '-' }}"
                                    readonly>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <label class="form-label">Pekerjaan</label>
                                <input type="text" class="form-control" value="{{ $user->pekerjaan_ibu ?? '-' }}"
                                    readonly>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Jenjang Pendidikan</label>
                                <input type="text" class="form-control"
                                    value="{{ $user->jenjang_pendidikan_ibu ?? '-' }}" readonly>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Penghasilan</label>
                    ...
                    <div class="tab-pane fade" id="detail-wali">
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" value="{{ $user->nama_wali ?? '-' }}"
                                    readonly>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">NIK Wali</label>
                                <input type="text" class="form-control" value="{{ $user->nik_wali ?? '-' }}"
                                    readonly>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Tahun Lahir</label>
                            ...
                            <div class="col-md-6">
                                <label class="form-label">Jenjang Pendidikan</label>
                                <input type="text" class="form-control"
                                    value="{{ $user->jenjang_pendidikan_wali ?? '-' }}" readonly>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Penghasilan</label>
            ...
            <div class="tab-pane fade" id="view-bantuan">
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" value="{{ $user->penerima_kps }}" readonly>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">No. KPS</label>
                        <input type="text" class="form-control" value="{{ $user->no_kps ?? '-' }}" readonly>
                    </div>
                    <div class="col-md-12 mt-0">
                        <hr class="text-muted opacity-25">
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" value="{{ $user->no_kks ?? '-' }}" readonly>
                    </div>
                    <div class="col-md-12 mt-0">
                        <hr class="text-muted opacity-25">
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" value="{{ $user->alasan_layak_pip ?? '-' }}"
                            readonly>
                    </div>
                    <div class="col-md-12 mt-0">
                        <hr class="text-muted opacity-25">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="dropdown w-100">
                            <button class="form-select text-start w-100" type="button" data-bs-toggle="dropdown"
                                aria-expanded="false">
                                {{ $user->pesertaEkstrakurikuler?->count() . ' Ekstrakurikuler' }}
                            </button>
