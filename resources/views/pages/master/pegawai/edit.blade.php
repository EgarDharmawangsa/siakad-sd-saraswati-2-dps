                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select @error('agama') is-invalid @enderror" id="agama" name="agama"
                                ...
                                <option value="Kristen Protestan"
                                    {{ old('agama', $pegawai->agama) === 'Kristen Protestan' ? 'selected' : '' }}>Kristen
                                    Protestan
                                </option>
                                <option value="Kristen Katolik"
                                    {{ old('agama', $pegawai->agama) === 'Kristen Katolik' ? 'selected' : '' }}>
                                    Kristen Katolik
                                </option>
                                ...
                                <option value="Tidak Beragama"
                                    {{ old('agama', $pegawai->agama) === 'Tidak Beragama' ? 'selected' : '' }}>
                                    Tidak Beragama
                                </option>
                            </select>
                            @error('agama')
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select @error('status_perkawinan') is-invalid @enderror"
                                ...
                                <option value="Sudah"
                                    {{ old('status_perkawinan', $pegawai->status_perkawinan) === 'Sudah' ? 'selected' : '' }}>
                                    Sudah
                                </option>
                                <option value="Pernah"
                                    {{ old('status_perkawinan', $pegawai->status_perkawinan) === 'Pernah' ? 'selected' : '' }}>
                                    Pernah
                                </option>
                                <option value="Belum"
                                    {{ old('status_perkawinan', $pegawai->status_perkawinan) === 'Belum' ? 'selected' : '' }}>
                                    Belum
                                </option>
                            </select>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control @error('no_telepon_seluler') is-invalid @enderror"
                                ...
                                placeholder="Masukkan no. telepon seluler"
                        ...
                        <div class="col-md-6">
                            ...
                            <img src='{{ $pegawai->foto ? asset("storage/{$pegawai->foto}") : '' }}'
                                class="foto mt-2 mb-3 {{ $pegawai->foto ? '' : 'd-none' }}"
                                id="image-preview">
                            <button type="button"
                            ...
                            <input type="file"
                                class="form-control @error('foto') is-invalid @enderror image-input"
                                id="foto" name="foto">
                            @error('foto')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <select class="form-select @error('posisi') is-invalid @enderror" id="posisi"
                                ...
                                <option value="Staf Tata Usaha"
                                    {{ old('posisi', $pegawai->posisi) === 'Staf Tata Usaha' ? 'selected' : '' }}>Staf Tata
                                    Usaha
                                </option>
                                <option value="Guru" {{ old('posisi', $pegawai->posisi) === 'Guru' ? 'selected' : '' }}>
                                    Guru
                                </option>
                                <option value="Pegawai Perpustakaan"
                                    {{ old('posisi', $pegawai->posisi) === 'Pegawai Perpustakaan' ? 'selected' : '' }}>
                                    Pegawai Perpustakaan
                                </option>
                                <option value="Pegawai Kebersihan"
                                    {{ old('posisi', $pegawai->posisi) === 'Pegawai Kebersihan' ? 'selected' : '' }}>
                                    Pegawai Kebersihan
                                </option>
                                <option value="Satuan Pengamanan"
                                    {{ old('posisi', $pegawai->posisi) === 'Satuan Pengamanan' ? 'selected' : '' }}>Satuan
                                    Pengamanan
                                </option>
                            </select>
                            @error('posisi')
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select @error('status_kepegawaian') is-invalid @enderror"
                                ...
                                <option value="Honorer"
                                    {{ old('status_kepegawaian', $pegawai->status_kepegawaian) === 'Honorer' ? 'selected' : '' }}>
                                    Honorer</option>
                                <option value="Kontrak"
                                    {{ old('status_kepegawaian', $pegawai->status_kepegawaian) === 'Kontrak' ? 'selected' : '' }}>
                                    Kontrak</option>
                                <option value="Tetap"
                                    {{ old('status_kepegawaian', $pegawai->status_kepegawaian) === 'Tetap' ? 'selected' : '' }}>
                                    Tetap
                                </option>
                                <option value="Tidak Tetap"
                                    {{ old('status_kepegawaian', $pegawai->status_kepegawaian) === 'Tidak Tetap' ? 'selected' : '' }}>
                                    Tidak Tetap</option>
                            </select>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control @error('nip') is-invalid @enderror" id="nip"
                                name="nip" placeholder="Masukkan NIP" value="{{ old('nip', $pegawai->nip) }}"
                                required>
                            @error('nip')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select @error('jabatan') is-invalid @enderror" id="jabatan"
                                ...
                                <option value="Pengatur Muda | II/a"
                                    {{ old('jabatan', $pegawai->jabatan) === 'Pengatur Muda | II/a' ? 'selected' : '' }}>
                                    Pengatur Muda | II/a
                                </option>
                                <option value="Pengatur Muda Tk. I | II/b"
                                    {{ old('jabatan', $pegawai->jabatan) === 'Pengatur Muda Tk. I | II/b' ? 'selected' : '' }}>
                                    Pengatur Muda
                                    Tk. I | II/b</option>
                                <option value="Pengatur | II/c"
                                    {{ old('jabatan', $pegawai->jabatan) === 'Pengatur | II/c' ? 'selected' : '' }}>
                                    Pengatur | II/c</option>
                                <option value="Pengatur Tk. I | II/d"
                                    {{ old('jabatan', $pegawai->jabatan) === 'Pengatur Tk. I | II/d' ? 'selected' : '' }}>
                                    Pengatur Tk. I | II/d
                                </option>
                                <option value="Penata Muda | III/a"
                                    {{ old('jabatan', $pegawai->jabatan) === 'Penata Muda | III/a' ? 'selected' : '' }}>
                                    Penata Muda | III/a
                                </option>
                                <option value="Penata Muda Tk. I | III/b"
                                    {{ old('jabatan', $pegawai->jabatan) === 'Penata Muda Tk. I | III/b' ? 'selected' : '' }}>
                                    Penata Muda Tk. I
                                    | III/b</option>
                                <option value="Penata | III/c"
                                    {{ old('jabatan', $pegawai->jabatan) === 'Penata | III/c' ? 'selected' : '' }}>
                                    Penata | III/c</option>
                                <option value="Penata Tk. I | III/d"
                                    {{ old('jabatan', $pegawai->jabatan) === 'Penata Tk. I | III/d' ? 'selected' : '' }}>
                                    Penata Tk. I | III/d
                                </option>
                                <option value="Pembina | IV/a"
                                    {{ old('jabatan', $pegawai->jabatan) === 'Pembina | IV/a' ? 'selected' : '' }}>
                                    Pembina | IV/a</option>
                                <option value="Pembina Tk. I | IV/b"
                                    {{ old('jabatan', $pegawai->jabatan) === 'Pembina Tk. I | IV/b' ? 'selected' : '' }}>
                                    Pembina Tk. I | IV/b
                                </option>
                                ...
                                <option value="Pembina Utama Madya | IV/d"
                                    {{ old('jabatan', $pegawai->jabatan) === 'Pembina Utama Madya | IV/d' ? 'selected' : '' }}>
                                    Pembina Utama
                                    Madya | IV/d</option>
                                <option value="Pembina Utama | IV/e"
                                    {{ old('jabatan', $pegawai->jabatan) === 'Pembina Utama | IV/e' ? 'selected' : '' }}>
                                    Pembina Utama | IV/e
                                </option>
                            </select>
                            @error('jabatan')
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date"
                                ...
                                value="{{ old('permulaan_kerja_sds2', $pegawai->permulaan_kerja_sds2->format('Y-m-d')) }}"
                                required>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control @error('tahun_ijazah') is-invalid @enderror"
                                ...
                                value="{{ old('tahun_ijazah', $pegawai->tahun_ijazah) }}" min="1900"
                                max="{{ date('Y') }}">
                            @error('tahun_ijazah')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select @error('status_sertifikasi') is-invalid @enderror"
                                ...
                                <option value="Sudah"
                                    {{ old('status_sertifikasi', $pegawai->status_sertifikasi) === 'Sudah' ? 'selected' : '' }}>
                                    Sudah
                                </option>
                                <option value="Belum"
                                    {{ old('status_sertifikasi', $pegawai->status_sertifikasi) === 'Belum' ? 'selected' : '' }}>
                                    Belum
                                </option>
                            </select>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control @error('tahun_sertifikasi') is-invalid @enderror"
                                ...
                                value="{{ old('tahun_sertifikasi', $pegawai->tahun_sertifikasi) }}" min="1900"
                                max="{{ date('Y') }}" required>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" class="form-control @error('tanggal_sk_terakhir') is-invalid @enderror"
                                ...
                                value="{{ old('tanggal_sk_terakhir', $pegawai->tanggal_sk_terakhir?->format('Y-m-d')) }}"
                                required>
