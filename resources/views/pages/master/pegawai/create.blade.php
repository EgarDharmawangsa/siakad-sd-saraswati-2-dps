                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="dropdown" id="guru-mata-pelajaran">
                                <button class="form-select text-start" type="button" data-bs-toggle="dropdown" aria-expanded="false" id="guru-mata-pelajaran-dropdown-button">
                                    -- Pilih Mata Pelajaran --
                                </button>
                                <ul class="dropdown-menu w-100 p-2 guru-mata-pelajaran-dropdown-menu" aria-labelledby="guru-mata-pelajaran-dropdown-button">
                                    @forelse ($mata_pelajaran as $_mata_pelajaran)
                                        <li><label class="dropdown-item"><input type="checkbox" value="{{ $_mata_pelajaran->id_mata_pelajaran }}" class="form-check-input me-2 guru-mata-pelajaran-item">{{ $_mata_pelajaran->nama_mata_pelajaran }}</label></li>
                                    @empty
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select @error('status_kepegawaian') is-invalid @enderror"
                                ...
                                <option value="2" {{ old('status_kepegawaian') == '2' ? 'selected' : '' }}>Honorer
                                </option>
                                <option value="3" {{ old('status_kepegawaian') == '3' ? 'selected' : '' }}>Kontrak
                                </option>
                            </select>
                        ...
                        <div class="col-md-6">
                            <label for="pangkat" class="form-label">Pangkat<span
                                    class="text-muted mini-label ms-1">(Opsional)</span></label>
                            <input type="text" class="form-control @error('pangkat') is-invalid @enderror"
                                id="pangkat" name="pangkat" placeholder="Masukkan pangkat"
                                value="{{ old('pangkat') }}">
                            @error('pangkat')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        {{-- <div class="col-md-6 mb-4">
                            <label for="golongan_ruang" class="form-label">Golongan Ruang<span
                                    class="text-muted mini-label ms-1">(Opsional)</span></label>
                            <input type="text" class="form-control @error('golongan_ruang') is-invalid @enderror"
                                id="golongan_ruang" name="golongan_ruang" placeholder="Masukkan golongan ruang"
                                value="{{ old('golongan_ruang') }}">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('no_sk') is-invalid @enderror"
                                id="no_sk" name="no_sk" placeholder="Masukkan no. SK terakhir"
                                value="{{ old('no_sk') }}">
                            @error('no_sk')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
