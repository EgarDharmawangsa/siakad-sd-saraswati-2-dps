...
@section('container')
    <div class="content-card mb-4">
        ...
        <div class="show-buttons">
            <a href="{{ route('ekstrakurikuler.index') }}" class="btn btn-secondary"><i
                    class="bi bi-arrow-left me-2"></i>Kembali</a>
            @can('staf-tata-usaha')
                <a href="{{ route('ekstrakurikuler.edit', $ekstrakurikuler->id_ekstrakurikuler) }}" class="btn btn-warning"><i
