                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('nama_pembina') is-invalid @enderror" id="nama-pembina"
                            name="nama_pembina" placeholder="Ketikkan nama pembina"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('alamat_pembina') is-invalid @enderror" id="alamat-pembina"
                            name="alamat_pembina" placeholder="Ketikkan alamat pembina"
                    ...
                    <div>
                        ...
                        <input type="text" class="form-control @error('no_telepon') is-invalid @enderror" id="no-telepon"
                            name="no_telepon" placeholder="Ketikkan no. telepon"
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('hari') is-invalid @enderror" id="hari" name="hari" required>
                            ...
                            <option value="0" {{ old('hari', $ekstrakurikuler->hari) == '0' ? 'selected' : '' }}>Senin</option>
                            <option value="1" {{ old('hari', $ekstrakurikuler->hari) == '1' ? 'selected' : '' }}>Selasa</option>
                            <option value="2" {{ old('hari', $ekstrakurikuler->hari) == '2' ? 'selected' : '' }}>Rabu</option>
                            <option value="3" {{ old('hari', $ekstrakurikuler->hari) == '3' ? 'selected' : '' }}>Kamis</option>
                            <option value="4" {{ old('hari', $ekstrakurikuler->hari) == '4' ? 'selected' : '' }}>Jumat</option>
                            <option value="5" {{ old('hari', $ekstrakurikuler->hari) == '5' ? 'selected' : '' }}>Sabtu</option>
                            <option value="6" {{ old('hari', $ekstrakurikuler->hari) == '6' ? 'selected' : '' }}>Minggu</option>
                        </select>
                        @error('hari')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="mb-3">
                        ...
                        <input type="time" class="form-control @error('jam_mulai') is-invalid @enderror" id="jam-mulai"
                            name="jam_mulai" value="{{ old('jam_mulai', $ekstrakurikuler->jam_mulai) }}" required>
                        @error('jam_mulai')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
