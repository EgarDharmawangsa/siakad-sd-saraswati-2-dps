                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('nama_ekstrakurikuler') is-invalid @enderror"
                            ...
                            placeholder="Ketikkan nama ekstrakurikuler"
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('hari') is-invalid @enderror" id="hari" name="hari"
                            ...
                            <option value="0" {{ old('hari', $ekstrakurikuler->hari) == '0' ? 'selected' : '' }}>Senin
                            </option>
                            <option value="1" {{ old('hari', $ekstrakurikuler->hari) == '1' ? 'selected' : '' }}>
                                Selasa</option>
                            <option value="2" {{ old('hari', $ekstrakurikuler->hari) == '2' ? 'selected' : '' }}>Rabu
                            </option>
                            <option value="3" {{ old('hari', $ekstrakurikuler->hari) == '3' ? 'selected' : '' }}>Kamis
                            </option>
                            <option value="4" {{ old('hari', $ekstrakurikuler->hari) == '4' ? 'selected' : '' }}>Jumat
                            </option>
                            <option value="5" {{ old('hari', $ekstrakurikuler->hari) == '5' ? 'selected' : '' }}>Sabtu
                            </option>
                            <option value="6" {{ old('hari', $ekstrakurikuler->hari) == '6' ? 'selected' : '' }}>
                                Minggu</option>
                        </select>
                        @error('hari')
                            <div class="invalid-feedback">{{ $message }}</div>
                    ...
                    <div>
                        ...
                        <input type="text" class="form-control @error('jam_selesai') is-invalid @enderror"
                            id="jam-selesai" name="jam_selesai"
                            value="{{ old('jam_selesai', $ekstrakurikuler->jam_selesai) }}" required>
                        @error('jam_selesai')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
