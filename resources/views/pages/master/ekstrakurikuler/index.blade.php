...
@section('container')
    <div class="content-card">
        <div class="d-flex align-items-center flex-wrap mb-4">
            <a href="{{ route('ekstrakurikuler.create') }}" class="btn btn-success create-button"><i
            ...
            <div class="modifier-buttons">
                <div class="dropdown me-2">
                    <a class="btn btn-secondary dropdown-toggle order-by-dropdown-toggle" href="#" role="button"
                        ...
                        <i
                            class="bi bi-sort-down me-2"></i>{{ request('order_by') === 'desc' || !request('order_by') ? 'Terbaru ke Lama' : 'Lama ke Terbaru' }}
                    </a>
