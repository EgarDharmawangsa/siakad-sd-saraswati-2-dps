...
@section('container')
    <div class="content-card mb-4">
        ...
        <div class="show-buttons">
            ...
            @canany(['guru', 'siswa'])
                <a href="{{ route('beranda') }}" class="btn btn-secondary"><i class="bi bi-arrow-left me-2"></i>Kembali</a>
            @endcan
            
            @can('staf-tata-usaha')
                <a href="{{ route('pengumuman.edit', $pengumuman->id_pengumuman) }}" class="btn btn-warning"><i
