    ...
    <div class="content-card">
        ...
        @forelse ($kelas as $_kelas)
            <div class="jadwal-pelajaran-container">
                ...
                <p class="text-muted mb-0 wali-kelas-label">Wali Kelas : {{ $_kelas->pegawai->nip ?? $_kelas->pegawai->nipppk ?? '-' }} | {{ $_kelas->pegawai->nama_pegawai }}</p>
                <hr class="mb-3">

                @forelse ($_kelas->jadwalPelajaran as $_jadwal_pelajaran)
