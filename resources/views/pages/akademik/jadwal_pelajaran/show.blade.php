...
@section('container')
    <div class="content-card mb-4">
        ...
        <div class="show-buttons">
            <a href="{{ route('jadwal-pelajaran.index') }}" class="btn btn-secondary"><i
                    class="bi bi-arrow-left me-2"></i>Kembali</a>
            @can('staf-tata-usaha')
                <a href="{{ route('jadwal-pelajaran.edit', $jadwal_pelajaran->id_jadwal_pelajaran) }}" class="btn btn-warning"><i
