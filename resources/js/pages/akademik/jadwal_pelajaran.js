...
if (kegiatan && id_guru_mata_pelajaran && mata_pelajaran) {
    const id_guru_mata_pelajaran_raw_data =
        id_guru_mata_pelajaran.dataset.guruMataPelajaran;
    const id_guru_mata_pelajaran_data =
        JSON.parse(id_guru_mata_pelajaran_raw_data) || [];
