...
class UpdateSiswaRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'nik'                       => ['required', 'numeric', 'digits:16', Rule::unique('siswa', 'nik')->ignore($id_siswa, 'id_siswa')],
            'nisn'                      => ['required', 'numeric', Rule::unique('siswa', 'nisn')->ignore($id_siswa, 'id_siswa')],
            'nipd'                      => ['required', 'numeric', Rule::unique('siswa', 'nipd')->ignore($id_siswa, 'id_siswa')],
            ...
            'nomor_urut'                => ['nullable', 'integer', Rule::unique('siswa')->where(fn ($query) => $query->where('id_kelas', $id_kelas))->ignore($id_siswa, 'id_siswa')]
        ];
    }
}