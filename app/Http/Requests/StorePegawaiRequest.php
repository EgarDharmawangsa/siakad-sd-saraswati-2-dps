...
class StorePegawaiRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'nik'                   => 'required|string|size:16|unique:pegawai,nik|unique:siswa,nik',
            'nip'                   => 'nullable|string|size:18|unique:pegawai,nip',
            'nipppk'                => 'nullable|string|size:18|unique:pegawai,nipppk',
