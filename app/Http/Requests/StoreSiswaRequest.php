...
class StoreSiswaRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $rules = [
            ...
            'nik'                       => 'required|string|size:16|unique:siswa,nik|unique:pegawai,nik',
            'nisn'                      => 'required|string|size:10|unique:siswa,nisn',
            'nipd'                      => 'nullable|string|min:3|max:15|unique:siswa,nipd',
            ...
            'e_mail'                    => 'nullable|email|min:3|max:255|unique:siswa,e_mail|unique:pegawai,e_mail',
            ...
            'lintang'                   => ['nullable', 'string', 'min:3', 'max:25', 'regex:/^-?\d+(\.\d+)?$/'],
            'bujur'                     => ['nullable', 'string', 'min:3', 'max:25', 'regex:/^-?\d+(\.\d+)?$/'],
            ...
            'penerima_kip'              => 'required|string|min:2|max:5',
            'no_kip'                    => 'nullable|string|min:10|max:13|unique:siswa,no_kip',
            'nama_kip'                  => 'nullable|string|min:3|max:255',
            'layak_pip'                 => 'nullable|string|min:2|max:5',
            ...
            'no_seri_ijazah'            => 'nullable|string|min:15|max:30|unique:siswa,no_seri_ijazah',
            ...
            'skhun'                     => 'nullable|string|min:5|max:15|unique:siswa,skhun',
        ];
